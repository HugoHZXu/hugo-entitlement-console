export const DEMO_ACCOUNT_STORAGE_KEY = 'entitlementConsole.demoAccountUserId';
export const DEMO_ENTITLEMENT_ORGANIZATION_STORAGE_KEY =
  'entitlementConsole.demoEntitlementOrganizationId';
export const IDENTITY_ACCESS_TOKEN_STORAGE_KEY = 'entitlementConsole.identityAccessToken';
export const IDENTITY_ACCESS_TOKEN_EXPIRES_AT_STORAGE_KEY =
  'entitlementConsole.identityAccessTokenExpiresAt';
