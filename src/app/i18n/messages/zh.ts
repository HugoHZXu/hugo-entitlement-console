const zhMessages = {
  ...
  accessState: {
    ...
    error: {
      message: '当前无法加载演示身份上下文。请确认 identity-service 已启动，或重试请求。',
      pageTitle: '账号不可用',
      title: '无法加载账号上下文',
    },
    loading: {
      message: '正在加载选中的演示账号和授权组织范围。',
      pageTitle: '正在加载账号',
      title: '正在检查授权访问',
    },
    noAccounts: {
      message: 'identity-service 没有返回可切换的演示账号。',
      pageTitle: '没有演示账号',
      title: '没有可用的演示账号',
    },
    noEntitlementScope: {
      message: '选中的演示账号没有授权组织范围。请切换账号以查看授权数据。',
      pageTitle: '没有授权访问',
      title: '没有可用的授权组织',
    },
    organizationUnavailable: {
      message: '选中的授权组织不是启用状态。如有其他组织范围，请切换后继续查看。',
      pageTitle: '组织不可用',
      title: '选中的组织不可用',
    },
    renewing: {
      message: '正在刷新演示身份 token，然后继续加载授权数据。',
      pageTitle: '正在刷新会话',
      title: '正在刷新账号上下文',
    },
  },
  identity: {
    account: {
      contextUnavailable: '账号上下文不可用。',
      current: '当前',
      fallbackNotice: '选中的账号不可用，已切换到默认演示账号。',
      fallbackName: '演示账号',
      listLabel: '演示账号',
      loading: '正在加载账号',
      multipleEntitlementAccess: '{count} 个授权组织',
      noAccounts: 'identity-service 暂无可用演示账号。',
      noEntitlementAccess: '没有授权组织访问',
      openMenu: '打开账号菜单',
      retry: '重试账号上下文',
      retryMeta: '重新加载 identity-service 会话',
      singleEntitlementAccess: '授权范围：{organization}',
      switchAccount: '切换账号',
      switchAccountMeta: '选择一个合成演示账号',
      switchModalTitle: '切换演示账号',
      unavailable: '账号不可用',
    },
    organization: {
      current: '当前组织',
      ...
      menuMeta: '用于产品、已分配用户和活动日志。',
      menuTitle: '授权组织',
      noScope: '此账号没有可用的授权组织。',
      placeholder: '选择组织',
      scopeLabel: '授权组织',
      status: {
        active: '启用',
  ...
  pages: {
    ...
    products: {
      empty: '当前没有授予 {organization} 的产品。',
      emptyDescription: '当前没有授予 {organization} 的产品。',
      emptyTitle: '暂无产品数据',
      loading: '正在加载产品...',
      title: '产品',
